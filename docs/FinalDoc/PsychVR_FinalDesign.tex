...
\begin{figure}[H]
	\label{fig:seatingCode}
	\lstinputlisting [ C] {seatingAlgorithm.txt}
...
The meshes of individual terrain chunks are generated by a Perlin noise sampling, they are also 

\begin{figure}[H]
	\label{fig:TerrainChunkGen}
	\lstinputlisting [ C] {chunkGen.txt}
	\caption{Terrain Chunk Gerneration Pseudo Code by Eric Momper}
\end{figure}
