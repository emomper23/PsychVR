...
Users may optionally respond to a questionnaire after the scene. In addition to this the scene will track how high up the user went and how much time was spent at each level. All of these metrics will be combined and analyzed over multiple sessions to provide the user feedback on their efforts.%NEEDS WORK spreadsheet?
...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{heightSurvey.png}
		\label{heightSurvey}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{heightQtGraph.png}
		\label{heightQtGraph}
		\caption{Fear of Heights Data Graph}
	\end{minipage}\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{heightQtSurveyResults.png}
...
Upon launch the user will deliver their speech to the configured audience. The slides can be traversed with the "Next" and "Prev" buttons. When the user is finished 
...
%TODO TERRAIN STORYBOARD
	...
	\centerline {\includegraphics[scale = 0.13, angle = 180]{heightQtSurveyResults.png}}%DIFFERENT IMAGE
