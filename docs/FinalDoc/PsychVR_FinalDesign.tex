...
%B. Technical objectives, goals, specifications, and requirements (mostly text and numbers) FIRST PAPER HERE EZPZ
	...
	I also have taken computer graphics with Dr. Leinecker, robot vision with Doctor Lobo, and am currently taking a Graduate Graphics class with Dr. Pattanaik. This project is very interesting to me as  
	...
	of Virtual Reality on patients with various disorders. My focus in the project is on the Qt configuration settings in unity as I have experience with Qt and C++, I will 
	also work on the configurable parts of the Unity scene and will assist with basic scene design, scripting, anc controller design.My computer will be the main machine to run the system for our project and for more powerful headset options, 
	as my GPU/CPU AMD R9 390 / I7 4790k/ 16GB DDR3 2133mhz can run most VR systems at a high resolution and frame rate,.
...
\section{Specifications and Requirements}
	...
	\item Media Assets
	\begin{itemize}
	  \item Description: Game Character models need to be designed or purchased. Autodesk Maya, Google Sketchup, and blender have been used for designing additional models. 
	...
	\end{itemize} %MORE on animation?
	\end{enumerate}

	\subsection{Data Requirements}%JOHN JOHN JOHN
	\begin{enumerate}
	...
	\subsection{Human Factors Requirements} %MORE JOHN
	\begin{enumerate}
	\item UI Simplicity
	    \begin{itemize}
	...
	\begin{enumerate}
	 ...
	 \item Accessibility of Guides
	  \begin{itemize}
	    \item Description: Make sure the guides are included. %NEEDS WORK DO WE NEED A GUIDE?
...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{qtHeightSettings.png}
		\label{qtHeightSettings}
		\caption{Fear of Heights Configuration}
	\end{minipage}\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{heightSS1.png}
		\label{heightSS1}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{heightSS2.png}
		\label{heightSS2}
		\caption{Fear of Heights Leaning}
	\end{minipage}\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{qtHeightSurvey.png}
		\label{heightSurvey}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{qtHeightGraph.png}
		\label{heightQtGraph}
		\caption{Fear of Heights Data Graph}
	\end{minipage}\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{qtHeightProgress.png}
		\label{heightQtSurveyResults}
		\caption{Fear of Heights Progress Graph}
	\end{minipage}
\end{figure}

\begin{enumerate} %MAKE BETTER?
	...
	\item They are then shown a results screen based on data acquired from sensors consisting of high they went and the time it took, and their responses to the questionnaire
\end{enumerate}
\pagebreak
\subsection{Module 2 Speech Anxiety Simulator} %PETER PETER PETER PETER
...
\par~\\
To further customize the scene the user may load a power point through Qt which will then display it onto the screen behind them as in an actual classroom.
...
\subsubsection{Models and Resources}
For the speech anxiety module we designed a classroom for the user to practice speaking in, relevant objects to go in it such as a Power Point display, and human models to listen to the speaker. The majority of models used for this scene have been designed in Google SketchUp while the human models were created in MakeHuman. Animations and rigs were built with our Kinect sensor using iPi Recorder 3 and iPi Mocap Studio 3.
...
Each of the animation types can be enabled or disabled from the launcher such as sleeping or sitting up. The user will also be able to include a Power Point in the scene configuration so they may have a presentation aid during their practice.

\subsubsection{User Progress Feedback}
Users may optionally respond to a questionnaire before and after the scene. In addition to the optional survey metrics, throughout the scene the users head, and where they are looking (ex: eye contact) will be tracked in order to provide feedback about their performance during the scene. All of these metrics will be combined and analyzed over multiple sessions to provide the user detailed feedback on their efforts and performance. %NEEDS WORK spreadsheet?
...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{qtSpeechSettings.png}
		\label{qtSpeechSettings}
		\caption{Speech Anxiety Configuration}
	\end{minipage}\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{speechSS1.png}
		\label{speechSS1}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{speechSS2.png}
		\label{speechSS2}
		\caption{Speech Anxiety Leaning}
	\end{minipage}\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{qtSpeechSurvey.png}
		\label{qtSpeechSurvey}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{qtSpeechGraph.png}
		\label{qtSpeechGraph}
		\caption{Speech Anxiety Data Graph}
	\end{minipage}\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=210px, height=210px, keepaspectratio]{qtSpeechProgress.png}
		\label{qtSpeechProgress}
...
\end{enumerate}
\pagebreak
\subsection{Module 3 Calm Environment} % SO HYPED!!! %TODO TERRAIN DETAILS CONTROLLER, STITCHING, GEN
...
\begin{figure}[H] %https://www.assetstore.unity3d.com/en/#!/content/59736
%TODO TERRAIN STORYBOARD

	\centerline {\includegraphics[scale = 0.13, angle = 180]{unityMecanim.png}}%DIFFERENT IMAGE
...
The Individual terrain chunks have a maximum x, and z size and and height limit y there is also a cell size that controls the number of triangle 
