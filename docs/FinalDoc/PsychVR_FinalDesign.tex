...
\pagebreak
\subsubsection{Module Storyboard: Calming Environment}
\begin{figure}[H]
	\centering
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=200px, height=210px, keepaspectratio]{qtCalmSettings.png}
		\labelq
		\caption{Calming Environment Configuration}
	\end{minipage}\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=200px, height=210px, keepaspectratio]{calmSpawn.png}
		\label{speechSS1}
		\caption{Speech Calming Environment Start}
	\end{minipage}
\end{figure}
\begin{figure}[H]
	\centering
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=200px, height=210px, keepaspectratio]{calmMove.png}
		\label{speechSS2}
		\caption{Calming Environment Movement}
	\end{minipage}\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=200px, height=210px, keepaspectratio]{qtCalmSurvey.png}
		\label{qtSpeechSurvey}
		\caption{Calming Environemnt Exit}
	\end{minipage}
\end{figure}
