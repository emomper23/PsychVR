...
\begin{enumerate}
    ...
    \end{itemize}
     \item User Movement Tracking
     \begin{itemize}
	\item Test Objective: Check that user movement tracking works
	\item Test Description: Kinect, leap motion, and Occulus rift should enable the user to move around the scene and have rotation and be able to interact with their hands.
	...
	\item Expected Results: The scene movements should be fluid and accurate.
    \end{itemize}
\end{enumerate}
